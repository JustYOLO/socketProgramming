...
print(f"received from {serverAddress}. Message is: {modifiedMessage}")
returnMessage = ""
for code in modifiedMessage.decode().split():
    returnMessage += chr(int(code))
print(f"ascii code converted to string: {returnMessage}")
clientSocket.close()
# 소켓 닫음